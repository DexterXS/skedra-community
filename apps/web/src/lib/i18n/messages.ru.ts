...
export const ruMessages = {
	...
	guestCanvas: {
		...enMessages.guestCanvas,
		menu: "Меню",
		share: "Поделиться",
		productDescription:
			"Skedra — бесплатная онлайн-доска для эскизов, интеллект-карт, диаграмм и Kanban-досок прямо в браузере и без аккаунта.",
		storageWarning:
			"Ваши рисунки сохраняются локально в браузере. Эти данные могут быть очищены в любой момент — регулярно сохраняйте доску в облако.",
		startDrawingHint: "Выберите инструмент и начинайте рисовать!",
		selfHost: {
			...enMessages.guestCanvas.selfHost,
			title: "Развернуть Skedra у себя",
			description:
				"Открытый исходный код на вашей инфраструктуре — полный контроль над данными и без облачной платной стены.",
		},
		onboarding: {
			...enMessages.guestCanvas.onboarding,
			menuHint: "Экспорт, настройки, языки…",
			toolbarHint: "Выберите инструмент и\nначинайте рисовать!",
			helpHint: "Горячие клавиши и помощь",
			panHintPrefix: "Чтобы перемещать холст, удерживайте",
			panHintWheel: "среднюю кнопку мыши",
			panHintOr: "или",
			panHintSpace: "Пробел",
			panHintSuffix: "во время перетаскивания или используйте инструмент «Рука».",
		},
		encryption: {
			...enMessages.guestCanvas.encryption,
			label: "Шифрование",
			title: "Ваши данные защищены",
			description:
				"В гостевом режиме всё остаётся локально в вашем браузере. При сохранении в облако доска передаётся по защищённому соединению и хранится на сервере в зашифрованном виде (AES-256).",
		},
		localHint: "Сохранено локально — войдите, чтобы синхронизировать и делиться",
		myBoards: "Мои доски",
		apiKeys: "API-ключи и MCP",
		signIn: "Войти",
		signUp: "Регистрация",
		saveToCloud: "Сохранить в облако",
		saveSkedra: "Сохранить как .skedra",
		saveExcalidraw: "Сохранить как .excalidraw",
		saveEncryptedSkedra: "Сохранить зашифрованный .skedra",
		openSkedra: "Открыть .skedra или .excalidraw",
		exportSvg: "Экспорт SVG",
		exportPng: "Экспорт PNG",
		exportPdf: "Экспорт PDF",
		exportPptx: "Экспорт PPTX",
		infoAndPricing: "Информация и тарифы",
		help: "Помощь",
		helpDescription: "Краткие подсказки для гостевого режима.",
		helpPan:
			"Перемещение холста: удерживайте среднюю кнопку мыши или Пробел при перетаскивании либо используйте инструмент «Рука» (H).",
		helpSave: "Сохранение в облако: кнопка «Поделиться» или меню — требуется вход.",
		helpExport: "Экспорт: SVG/PNG или .skedra через меню слева сверху.",
		clearCanvas: "Очистить холст",
		clearCanvasDescription:
			"Все элементы и сохранённые виды будут безвозвратно удалены.",
		clearCanvasConfirm: "Удалить всё",
		preferences: "Настройки",
		theme: "Тема",
		themeLight: "Светлая",
		themeDark: "Тёмная",
		themeSystem: "Системная",
		saveDialogTitle: "Сохранить доску",
		saveDialogDescription:
			"Текущий холст будет сохранён в вашем аккаунте и станет доступен с любого устройства.",
		boardName: "Название доски",
		saveEmptyError: "На доске пока нечего сохранять.",
		liveCollaboration: {
			...enMessages.guestCanvas.liveCollaboration,
			menuLabel: "Совместная работа…",
			title: "Совместная работа",
			description: "Пригласите других пользователей работать над рисунком вместе с вами.",
			privacy:
				"Сеанс работает через ваш аккаунт Skedra — совместно редактировать доску могут только пользователи с доступом к ней.",
			accountRequired: "Для совместной работы нужен аккаунт.",
			startSession: "Начать сеанс",
		},
	},
	skedraFile: {
		...enMessages.skedraFile,
		importConfirmTitle: "Заменить доску?",
		importConfirmDescription:
			"Открытый файл Skedra или Excalidraw заменит все элементы и сохранённые виды на текущем холсте.",
		importConfirmAction: "Загрузить файл",
		encryptedPassphrasePrompt:
			"Придумайте парольную фразу для зашифрованного файла .skedra (не менее 8 символов). Skedra не сможет её восстановить.",
		encryptedImportPassphrasePrompt:
			"Введите парольную фразу для этого зашифрованного файла .skedra.",
		errorTitle: "Не удалось загрузить файл",
		errors: {
			...enMessages.skedraFile.errors,
			invalidJson: "Файл не содержит корректный JSON.",
			invalidFormat: "Это некорректный файл .skedra.",
			unsupportedVersion: "Файл создан в более новой версии Skedra.",
			passphraseRequired: "Введите парольную фразу не короче 8 символов.",
			encryptedUnsupported: "Ваш браузер не поддерживает зашифрованные файлы .skedra.",
			decryptFailed:
				"Не удалось расшифровать файл .skedra. Проверьте парольную фразу.",
			unknown: "При загрузке файла произошла ошибка.",
		},
	},
	auth: {
		...enMessages.auth,
		login: {
			...enMessages.auth.login,
			title: "С возвращением",
			description: "Войдите в свой аккаунт Skedra",
		...
		register: {
			...enMessages.auth.register,
			title: "Создать аккаунт",
			description: "Создайте аккаунт Skedra и начните работу",
			name: "Имя",
			email: "Электронная почта",
			password: "Пароль",
